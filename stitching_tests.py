...
axes[0, 0].imshow(img1["arr_0"], cmap="hot")
axes[0, 1].imshow(img2["arr_0"], cmap="hot")
axes[0, 2].imshow(img3["arr_0"], cmap="hot")
axes[1, 0].imshow(img4["arr_0"], cmap="hot")
axes[1, 1].imshow(img5["arr_0"], cmap="hot")
